        ...
        try {
            const modelData = {
                patient_data: {
                    ...
                    gfr: patientData.gfr ? parseFloat(patientData.gfr) : null,
                    ...
                    TNBS_status: patientData.TNBS_status
                },
            ...
            console.log('Данные для математической модели:', JSON.stringify(modelData, null, 2));
